...
import { contentService, clientService } from "@/lib/supabase";
...
export default function ActivationPage() {
  ...
  const handleActivate = async () => {
    if (!agreed || !fullName || !selectedOption) return;

    setIsLoading(true);

    const paymentUrls = {
      A: "https://buy.stripe.com/test_activation_option_a", // Replace with actual Stripe payment link
      B: "https://buy.stripe.com/test_activation_option_b", // Replace with actual Stripe payment link
    };

    // In production, you would redirect to the actual Stripe payment URL
  ...
  if (isPageLoading || !content?.activation) {
    return (
      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center space-x-6 text-sm text-gray-500">
            ...
            <div className="flex items-center space-x-1">
              ...
              <span>{content.activation.guaranteeInfo.period}</span>
            </div>
            <div className="flex items-center space-x-1">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Contact: {client?.contact || "Contact Person"} (CEO)
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between py-4 px-5 rounded-xl bg-gradient-to-r from-purple-50 to-purple-100 hover:from-purple-100 hover:to-purple-150 transition-all">
                ...
                <span className="font-bold text-gray-900 text-lg">
                  {client?.position || "Position Title"}
                </span>
              </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start space-x-3 p-4 bg-white rounded-lg border border-gray-200">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mt-1">
                I have the authority to bind {client?.company || "this company"}{" "}
                to this agreement and understand the payment terms.
              </p>
            </div>
          </div>
          ...
          <Button
            ...
            disabled={!agreed || !fullName || !selectedOption || isLoading}
